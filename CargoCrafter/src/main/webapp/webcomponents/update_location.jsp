			...
			<div class="col-md-4">
				<div class="card-transparent left">
					<div class="card-body">
						...
						LocationDAOImpl dao = new LocationDAOImpl(DBConnect.getConn());
						Location loc = dao.getLocationsById(id);
						%>

							<div class="form-outline form-white mb-4">
								 <input
									type="text" name="source" id="name"
									class="form-control form-control-lg" value=<%=loc.getSource() %> placeholder="Enter Source Location"/>
							</div>

							<div class="form-outline form-white mb-4">
								<input
									type="text" name="destination" id="typeEmailX"
									class="form-control form-control-lg" value=<%=loc.getDestination() %> placeholder="Enter Destination Location"/>
							</div>

							<div class="form-outline form-white mb-4">
								 <input
									type="text" name="total_km" id="typePasswordX"
									class="form-control form-control-lg" value=<%=loc.getTotal_km() %> placeholder="Enter Total Km"/>
							</div>

							<div class="form-outline form-white mb-4">
								
								<input type="text" name="price_per_km" id="typePasswordX"
									class="form-control form-control-lg" value=<%=loc.getPrice_per_km() %> placeholder="Enter Price per KM"/>
							</div>
