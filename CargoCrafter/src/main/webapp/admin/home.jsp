	...
	<div class="wrapper">
		...
		<nav id="sidebar">
			...
			<ul class="list-unstyled components">
				...
				<div class="small-screen navbar-display">
					<ul>
						...
						<li class="d-lg-none d-md-block d-xl-none d-sm-block"><a
							href="#"><i class="material-icons">person</i><span>user</span></a></li>

						<li class="d-lg-none d-md-block d-xl-none d-sm-block"><a
							href="#"><i class="material-icons">settings</i><span>setting</span></a></li>
					</ul>
				</div>
				...
				<li><a href="add_location.jsp"><i class="material-icons">add_location</i><span>Add
							Location</span></a></li>
				<li><a href="../logout"><i class="material-icons">logout</i><span>
							Logout</span></a></li>
